...
public class KnownTypes {
	...
	protected void initialize(final Locale locale) {
		...
		final TypeInfo PI_SIGNED_LONG_TRAILING = new TypeInfo(ID.ID_SIGNED_LONG_TRAILING, PATTERN_SIGNED_LONG_TRAILING, FTAType.LONG, "SIGNED_TRAILING", TypeInfo.TRAILING_MINUS_FLAG);
		...
		final TypeInfo PI_SIGNED_DOUBLE_TRAILING = new TypeInfo(ID.ID_SIGNED_DOUBLE_TRAILING, PATTERN_SIGNED_DOUBLE_TRAILING, FTAType.DOUBLE, "SIGNED_TRAILING", TypeInfo.TRAILING_MINUS_FLAG);
