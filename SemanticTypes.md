...
|-------------|-----------|-------------|------|
|AIRLINE.IATA_CODE|IATA Airline Code|https://en.wikipedia.org/wiki/Airline_codes#IATA_airline_designator, https://schema.org/iataCode|*|
|AIRLINE.TEXT_EN|Airline Name||*|
|AIRPORT_CODE.IATA|IATA Airport Code|https://en.wikipedia.org/wiki/IATA_airport_code, https://schema.org/iataCode|*|
...
|CHECKDIGIT.EAN13|EAN-13 - EAN-13/ISBN-13 Check digit|https://www.wikidata.org/wiki/Property:P212, https://en.wikipedia.org/wiki/ISBN, https://schema.org/gtin13|*|
|CHECKDIGIT.IBAN|IBAN - International Bank Account Number|https://en.wikipedia.org/wiki/International_Bank_Account_Number|*|
|CHECKDIGIT.ISBN|ISBN-13 identifiers (with hyphens)|https://en.wikipedia.org/wiki/ISBN, https://schema.org/isbn|*|
...
|STATE_PROVINCE.PROVINCE_NAME_PE|Peruvian Province|https://en.wikipedia.org/wiki/Provinces_of_Peru, https://schema.org/State|es-PE|
