...
public class TestAuto {
	...
	@Test(groups = { TestGroups.ALL })
	public void testVendorName() throws IOException, FTAException {
		final TextAnalyzer analysis = new TextAnalyzer("vendor_name");
		analysis.setLocale(Locale.forLanguageTag("en-US"));

		final String[] inputs = {
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			...
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"GREAT WESTERN PARK & PLAYGROUND", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"ECONOMY HANDICRAFTS", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "ECONOMY HANDICRAFTS",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
			"OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV", "OFFICE DEPOT BUSINESS SVCS DIV",
		...
		assertEquals(result.getSampleCount(), 100);
		assertEquals(result.getType(), FTAType.STRING);
		assertEquals(result.getSemanticType(), "COMPANY_NAME");
	}
}
