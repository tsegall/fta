 ...
 */
public class DOWAbbr extends LogicalTypeFinite {
	 ...
	 */
	public DOWAbbr(final PluginDefinition plugin) {
		super(plugin);
	}
	...
	public boolean initialize(final AnalysisConfig analysisConfig) throws FTAPluginException {
		...
		days = localeInfo.getShortWeekdays();
	...
	public Set<String> getMembers() {
		return localeInfo.getShortWeekdays();
	}
	...
	public String getRegExp() {
		return localeInfo.getShortWeekdaysRegExp();
	}
	...
	public PluginAnalysis analyzeSet(final AnalyzerContext context, final long matchCount, final long realSamples, final String currentRegExp, final Facts facts, final FiniteMap cardinality, final FiniteMap outliers, final TokenStreams tokenStreams, final AnalysisConfig analysisConfig) {
		if (outliers.size() > 1)
			return new PluginAnalysis(localeInfo.getShortWeekdaysRegExp());
