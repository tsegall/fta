 ...
 */
public class LogicalTypeMiddleName extends LogicalTypeFirstName {
	...
	public LogicalTypeMiddleName(final PluginDefinition plugin) throws FileNotFoundException {
		super(plugin);
